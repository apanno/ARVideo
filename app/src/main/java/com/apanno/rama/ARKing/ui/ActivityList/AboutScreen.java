...
package com.apanno.arcer.ARKing.ui.ActivityList;
...
public class AboutScreen extends Activity implements OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.apanno.arcer.ARKing.R.layout.about_screen);
        ...
        mAboutWebText = (WebView) findViewById(com.apanno.arcer.ARKing.R.id.about_html_text);
        ...
        mStartButton = (Button) findViewById(com.apanno.arcer.ARKing.R.id.button_start);
        mStartButton.setOnClickListener(this);
        
        mAboutTextTitle = (TextView) findViewById(com.apanno.arcer.ARKing.R.id.about_text_title);
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case com.apanno.arcer.ARKing.R.id.button_start:
                startARActivity();
                break;
        }
    }
